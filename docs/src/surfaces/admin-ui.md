...
| **Design tokens** | The house design-token system. The shell's authoritative styling is the hand-authored `static/css/styles.css`, written from the token spec; it is *not* Tailwind/DaisyUI. |
